...
?>
    ...
    <head>
        ...
        <title>Mann's Solutions | Immigration Services | UK Citizenship | Tier 1 investor | Entrepreneur | Visas</title>
    ...
    <body>
        ...
        <div class="modal fade" id="free-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="loginmodal-container">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true"><i class="fa fa-times-circle-o fa-2x" aria-hidden="true"></i></button>
                    ...
                    <div class="modal-footer">
                        <p class="text-center">The Free consultation will only
                            <br>last 15 minutes.</p>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern Mann's Solutions's relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.
                            <br>
                            <br> The term Mann's Solutions or 'us' or 'we' refers to the owner of the website whose registered office is 3 Devonshire Street, London, W1W 5DT. Our company registration number is [company registration number and place of registration]. The term 'you' refers to the user or viewer of our website.
                            <br>
                            <br> The material on our Website is for general information only, it is current as at the stated date of publication, but does not constitute legal advice. You must take appropriate professional advice before taking or refraining from action based on any material on our Website. Mann’s Solutions accepts no liability whatsoever for any reliance upon the contents of this Website. Whilst you may access other websites from our Website, and our Website may refer to other websites, Mann’s Solutions accepts no liability in connection with any other website.
                        </p>
                    </div>
                    <div class="modal-footer">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="know-about-us wow animated fadeInLeft" data-wow-delay=".5s">
                                    ...
                                    <p style="color:black;">
                                        Mann's Solutions provides assistance in immigration, business, property and finance. We help our clients to obtain individual visas (Tier 2, Tier 4, Turkish Worker Visas), business visas (Tier 1 Investor and Entrepreneur, Sole Representative, Turkish Business person) and corporate visas (Tier 2 Sponsor, Tier 4 Sponsor). We are dedicated to providing the best services and guidance for assisting clients to live, set up business and establish themselves in the UK successfully and smoothly.
                                        <br>
                                        <br> Mann's Solutions is a professional team of advisors which own 40 years’ combined experience in immigration, investment, accounting and business services field. Our consulting services are provided in English, Russian, Turkish, Arabic and Chinese languages.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="our-skills wow animated fadeInRight" data-wow-delay=".5s">
                                    ...
                                    <div class="img-with-text">
                                        <img class="oisc img-responsive" src="images/oisc.jpg">
                                    </div>
                                    <h4 class="section-title regtitle">
                 <span>
                                                    ...
                                                    <center>
                                                        <div class="text-center">
                                                            <center>
                                                                <a href="#!" class="show_hide2 text-center vistypesback" data-content="toggle-text">&nbsp;</a>
                                                                <br>
                                                                <div class="listofvisas corporatelist" id="listofvisas">
                                                                    <ul>
                ...
                <div class="text">
                    <div class="container">
                            ...
                            <div class="col-md-4">
                                <div class="about-work wow animated fadeInRight" data-wow-delay=".5s">
                                    ...
                                    <p class="description" style="color:white;">
                                        ...
                                        <br>
                                        <br> An individual can apply under this type of visa if they want to set up or take over, and be involved in running a business. The successful applicant will need to score a total of 95 points on the Points Based System and meet all the necessary requirements under the Immigration Rules. You can achieve these points by having access to no less than £200 000 or £50 000.
                                        <br>
                                        <br> We can help applicants prepare the necessary documents for a successful application.
                                    </p>
                                </div>
                            </div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title" style="color:white;">ILR</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text" style="color:white;">3 or 5 years</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title" style="color:white;">NATURALISATION</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text" style="color:white;">can apply for naturalisation after 6 years</p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 info-button" style="t"><a href="#frank" class="ask" data-toggle="modal" data-target="#free-modal">Free Consultation</a>
                            </div>
                            ...
                            <div class="section-padding">
                                    ...
                                    <div class="visa-table text-center col-md-8">
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title">ILR</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text">after 5 years of residence in the UK</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title">NATURALISATION</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text">in the 6th year</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 info-button" style="t"><a href="#!" class="ask" data-toggle="modal" data-target="#free-modal">Free Consultation</a>
                                        </div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="bot-buffer row">
                                                ...
                                                <div class="visa-first visa-item col-md-2">
                                                    ...
                                                    <div class="row">Only 1 representative from an overseas company</div>
                                                </div>
                                                <div class="visa-item col-md-2">
                                                    <div class="row"><img class="visa-info" src="images/visa-table/family.png"></div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">after 4-5 years of residence in the UK</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">after 12 months of receiving ILR</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">10 years under long residency principle</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">only possible by switching Tiers</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">can only apply for extensions</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                    ...
                    <div class="about-bottom">
                        <div class="container">
                                ...
                                <div class="col-md-4">
                                    <div class="about-work wow animated fadeInRight" data-wow-delay=".5s">
                                        ...
                                        <p class="description">
                                            ...
                                            <br>
                                            <br> After an individual has lived in the UK for a specific period of time they can apply for ILR which grants them the right to stay in the UK for as long as they wish, and apply for naturalisation.
                                            <br>
                                            <br> It is possible to become a British citizen by naturalisation or registration. Generally, naturalisation as a British citizen is only possible after obtaining either Permanent Residence (for EEA nationals) or ILR and only after 12 months from the issue date of the residence document.
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">can be obtain by EU and non-EU citizens after 12 months of receiving ILR or PR</p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center">
                                <a href="#!" class="show_hide text-center" data-content="toggle-text">More Information</a>
                                <div class="content" style="text-align:left;">
                                    <p>To apply for British citizenship an individual will first need to obtain ILR or Permanent Residence (EEA nationals). Obtaining Naturalisation will mean that a person is no longer subject to immigration control.
                                        <br>
                                        <br> To achieve ILR a person will have to live in the UK for a continuous period of 5 years. Cannot leave the UK for a longer period than 450 days and 90 days during the last 12 months.
                                    </p>
                                    <ul class="readmorelist">
                                ...
                                <div class="col-md-4">
                                    <div class="about-work wow animated fadeInRight" data-wow-delay=".5s">
                                        ...
                                        <p class="description">
                                            ...
                                            <br>
                                            <br> The EEA Regulations grant the possibility for individuals to obtain permanent residence and bring their family with them, whether they are EEA nationals or are living outside of EU.
                                            <br>
                                            <br> EEA nationals can request a residence document after a certain amount of time has passed, granted their stay was for a continuous period without long-term leave.
                                            <br>
                                            <br> We can help applicant prepare the necessary documents for a successful application.
                                        </p>
                                    </div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">Permanent Residence after 5 years of continuous residence as a qualified person</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">Naturalisation can be obtained after 12 months of receiving Permanent Residence (PR)</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="about-work wow animated fadeInRight" data-wow-delay=".5s">
                                        ...
                                        <p class="description">
                                            ...
                                            <br>
                                            <br> Once granted, a sponsorship licence allows you to make an application to employ a person (or continue to employ a person).
                                            <br>
                                            <br> Various monitoring duties are expected to be followed and reported to the Home Office visa the SMS system. Any and all changes no matter the scope and size need to reported.
                                            <br>
                                            <br> We can help applicant prepare the necessary documents for a successful application.
                                        </p>
                                    </div>
                                    ...
                                    <div class="visa-table text-center col-md-8">
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title">License</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text">A valid license to employ migrants outside the EU.</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title">Extension</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text">After 4 years the license has to be extended</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="about-work wow animated fadeInRight" data-wow-delay=".5s">
                                        ...
                                        <p class="description">
                                            ...
                                            <br>
                                            <br> Those students who wish to come to the UK to study must be eligible to do so, and must have a reputable education provider who can genuinely provide adequate knowledge.
                                            <br>
                                            <br> The educational facility will be expected to report any change no matter the size or scope about the student to the Home Office via the SMS system.
                                            <br>
                                            <br> Failure to follow this system can result in the cancelation or downgrade of the licence.
                                            <br>
                                            <br> We can help applicant prepare the necessary documents for a successful application.
                                        </p>
                                    </div>
                                        ...
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <p class="benefit-text">A valid license to enrol students outside the EU.</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="about-work wow animated fadeInRight" data-wow-delay=".5s">
                                        ...
                                        <p class="description">
                                            ...
                                            <br>
                                            <br> Each business who holds such a licence should know where the migrant staff are during working hours and that any changes are recorded and updated appropriately via the SMS system.
                                            <br>
                                            <br> We can help applicant prepare the necessary documents for a successful application.
                                        </p>
                                    </div>
                                    ...
                                    <div class="visa-table text-center col-md-8">
                                        <div class="table" class="wow animated fadeInLeft" data-wow-delay=".5s">
                                            ...
                                            <div class="top-buffer row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title">LEGAL SUPPORT</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text"> Acting as your legal representative during Home Office visits</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <p class="benefit-title">RATING</p>
                                                    </div>
                                                    <div class="row">
                                                        <p class="benefit-text">Assisting you in keeping an A - rating</p>
                                                    </div>
                                                </div>
                                            </div>
  ...
  <div class="prices-list">
     <div class="container">
            <div class="row">
              <h2 class="section-title text-center"><span>Fees</span></h2>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
							<ul class="pricing p-green">
								<li>
									...
									<big>Visa In & Out of Country</big>
									<p class="title">View Prices</p>
								</li>
								<div class="content">
								<li style="color: #777;font-size: 14px;">Tier 1 (Investor) Visa - Main Applicant - £5,900</li>
								<li style="color: #777;font-size: 14px;">Tier 1 (Entrepreneur) Visa - Main Applicant - £4,000</li>
								<li style="color: #777;font-size: 14px;">Tier 1 (Graduate Entrepreneur) Visa - Main Applicant - £3,500</li>
								<li style="color: #777;font-size: 14px;">Tier 2 (General) Visa - Main Applicant - £750</li>
								<li style="color: #777;font-size: 14px;">Tier 2 Sponsorship Licence (Large Company) - £4,000</li>
                                <li style="color: #777;font-size: 14px;">Tier 2 Sponsorship Licence (Small Company) - £1,500</li>
                                <li style="color: #777;font-size: 14px;">Tier 4 Sponsorship Licence (Large Company) - £5,000</li>
                                <li style="color: #777;font-size: 14px;">Tier 4 Sponsorship Licence (Small Company) - £5,000</li>
                                <li style="color: #777;font-size: 14px;">Tier 4 (Student) Visa - Main Applicant - £700</li>
                                <li style="color: #777;font-size: 14px;">Tier 4 (Child) Visa - Main Applicant - £800</li>
                                <li style="color: #777;font-size: 14px;">Short-term Study Visa - Main Applicant - £550</li>
                                <li style="color: #777;font-size: 14px;">Turkish Business Person Visa - Main Applicant - £2500</li>
                                <li style="color: #777;font-size: 14px;">Turkish Worker Visa - Main Applicant - £1250</li>
                                <li style="color: #777;font-size: 14px;">Tier 5 Visa - Main Applicant - £750</li>
                                <li style="color: #777;font-size: 14px;">Sole Representative - Main Applicant - £3,750</li>
                                <li style="color: #777;font-size: 14px;">Spouse Visa - Main Applicant - £850</li>
                                <li style="color: #777;font-size: 14px;">Unmarried Partner Visa - Main Applicant - £950</li>
                                <li style="color: #777;font-size: 14px;">Visitor Visa - Main Applicant - £450</li>
                                <li style="color: #777;font-size: 14px;">European Schengen Visa - £250</li>
								<li>
									<button><a href="#!" data-toggle="modal" data-target="#login-modal" class="framed">Request a phone call</a></button>
								</li>
								</div>
							</ul>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
							<ul class="pricing p-yel">
								<li>
									...
									<big>Leave to Remain (FLR/ILR)</big>
									<p class="title2">View Prices</p>
								</li>
								<div class="content2">
								<li>ILR (PBS and others) - Main Applicant - £750</li>
								<li>ILR (10-year route) - Main Applicant - £1000</li>
								<li>ILR (Spouse) - Main Applicant - £750</li>
								<li>
									<button><a href="#!" data-toggle="modal" data-target="#login-modal" class="framed">Request a phone call</a></button>
								</li>
                                </div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
							<ul class="pricing p-red">
								<li>
									...
									<big>EEA Applications</big>
									<p class="title3">View Prices</p>
								</li>
								<div class="content3">
								<li>EEA Qualified Person - Main Applicant - £350</li>
								<li>EEA Family Member - Main Applicant - £500</li>
								<li>EEA Permanent Residence - Main Applicant - £550</li>
								<li>Each Dependant applying at the same time - £300</li>
								<li>Dependant applying separately - £550</li>
								<li>EEA Family Permit Main Applicant - £500</li>
								<li>
									<button><a href="#!" data-toggle="modal" data-target="#login-modal" class="framed">Request a phone call</a></button>
								</li>
                                </div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
							<ul class="pricing p-blue">
								<li>
									...
									<big>Other <br>Services</big>
									<p class="title4">View Prices</p>
								</li>
								<div class="content4">
								<li>Appeal Stage 1 - £900</li>
								<li>Appeal Stage 2 - £1,700<li>
                                <li>Out of time applications - £1,200<li>
                                <li>Transfer of Conditions – Postal Service - £300<li>
                                <li>Replacement BRP - £300<li>
                                <li>Subject Access Request - £250<li>
                                <li>20 Year long Residence Outside Immigration Rules - Main Applicant - £1,200<li>
                                <li>Naturalisation - £750<li>
                                <li>Registration of Minors as British Citizens (MN1/T) - £450/500<li>
                                <li>Lodge Administrative Review (out of country) - £950<li>
                                <li>Correction Visa - £280<li>
                                <li>Document Checking/Review - £250<li>
                                <li>PBS Administrative Review (out of country) - £950<li>
                                <li>Travel Document/ Certificate of Identity - £350<li>
								<li>
									<button><a href="#!" data-toggle="modal" data-target="#login-modal" class="framed">Request a phone call</a></button>
								</li>
                                </div>
  ...
  ------>
        ...
        <section id="contact-visas" class="testimonial text-center" data-stellar-background-ratio="0.1" data-stellar-vertical-offset="0">
            <div class="pattern-overlay" id="contactusform">
                <div class="section-padding">
                    <div class="container">
                        <div class="row">
                            <h2 class="section-title text-center"><span>Your questions matters</span></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="section-details">
                            <div class="post-area">
                                ...
                                <div class="col-md-3">
                                    <h4 class="entry-title"><a href="http://manns-solutions.com/go/?http://manns-solutions.co.uk/accounting/">Business Services<br>
                ...
                <article class="type-post post wow animated fadeInUp" data-wow-delay=".55s">
                  ...
                  <div class="post-content">
                    <p class="entry-content"></p>
                                ...
                                <div class="col-md-3">
                                    <h4 class="entry-title"><a href="http://manns-solutions.com/go/?http://manns-solutions.co.uk/property-investment-services/">Property<br>
                ...
                <article class="type-post post wow animated fadeInUp" data-wow-delay=".35s">
                  ...
                  <div class="post-content">
                    <p class="entry-content"></p>
                                ...
                                <div class="col-md-3">
                                    <h4 class="entry-title"><a href="http://manns-solutions.com/go/?http://manns-solutions.co.uk/uk-investment-services/">Financial Markets<br>
                ...
                <article class="type-post post wow animated fadeInUp" data-wow-delay=".75s">
                  ...
                  <div class="post-content">
                    <p class="entry-content"></p>
                                ...
                                <div class="col-md-3">
                                    <h4 class="entry-title"><a href="http://manns-solutions.com/go/?http://manns-solutions.co.uk/concierge/">Concierge<br>
                    ...
                    <div class="container">
                        ...
                        <div class="section-details wow animated fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="block-text rel zmin">
                                    <a title="" href="#">
                                        <div class="mark">Their rating: <span class="rating-input"><span data-value="0" class="glyphicon glyphicon-star"></span><span data-value="1" class="glyphicon glyphicon-star"></span><span data-value="2" class="glyphicon glyphicon-star"></span><span data-value="3" class="glyphicon glyphicon-star"></span><span data-value="4" class="glyphicon glyphicon-star"></span> </span>
                                        </div>
                                    </a>
        ...
        <!--Start Cookie Script-->
        <script type="text/javascript" charset="UTF-8" src="http://chs03.cookie-script.com/s/62c9f49b18f840528737a21b500585cd.js"></script>
        <!--End Cookie Script-->
        <script>
            $zopim(function () {
