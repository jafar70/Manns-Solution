            ...
            <div class="questions">
                <div class="container">
                    <div class="row">
                        ...
                        <br>
                        <center>
                            <h1>Ücretsiz Değerlendirme</h1>
                            <p style="color:white;">aşağıdaki formu doldurunuz</p>
                        </center>
                        <?php echo $result;?>
                            <form method="post" role="form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="inputdefault">İsminiz soy isminiz:</label>
                                        <input type="text" name="name" class="form-control" placeholder="İsminiz" value="<?php echo $_POST['name']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputdefault">E-mail:</label>
                                        <input type="email" name="email" class="form-control" placeholder="E-mailınız" value="<?php echo $_POST['email']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputdefault">Çocuklarınızın sayısı (mevcut ise):</label>
                                        <input type="NoChildren" name="NoChildren" class="form-control" placeholder="" value="<?php echo $_POST['NoChildren']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputdefault">Yetişkin aile üyesi sayısı (mevcut ise):</label>
                                        <input type="NoAdults" name="NoAdults" class="form-control" placeholder="" value="<?php echo $_POST['NoAdults']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputdefault">Tek Başınıza mı geleceksiniz?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Evlilik Durumunuz?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Mevcut vatandaşık(lar)ınız?</label>
                                        <input type="nation" name="nation" class="form-control" placeholder="" value="<?php echo $_POST['nation']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputdefault">Doğum tarihiniz?</label>
                                        <input type="dob" name="dob" class="form-control" pattern="\d{1,2}/\d{1,2}/\d{4}" placeholder="GG/AA/YYYY" value="<?php echo $_POST['dob']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputdefault">Telefon Numaranız:</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Daha önce başka bir vizeniz bulundu mu?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Vize başvurunuz hiç red edildi mi?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Birleşik Krallık’ta tedavi oldunuz mu?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Birleşik Krallıkta herhangi regüle edilmiş bir kurumdan kaynağın yerine getirildiğine dair bir mektup aldınız mı?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Mevcut para’nın sahibi siz misiniz?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputdefault">Ek bilgi/sorularınız/talepleriniz:</label>
