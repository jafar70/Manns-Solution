                ...
                <div class="container">
                    <div class="row">
                        ...
                        <table class="table table-list-search">
                            ...
                            <tbody>
                                <tr>
                                    <td>Tier 1 (Entrepreneur) Visa - Main Applicant</td>
                                    <td>4,000</td>
                                </tr>
                                <tr>
                                    <td>Tier 1 (Investor) Visa - Main Applicant</td>
                                    <td>5,900</td>
                                </tr>
                                <tr>
                                    <td>Tier 1 (Graduate Entrepreneur) Visa - Main Applicant</td>
                                    <td>3,500</td>
                                </tr>
                                <tr>
                                    <td>Sole Representative - Main Applicant</td>
                                    <td>3,750</td>
                                </tr>
                                <tr>
                                    <td>Turkish Business Person Visa - Main Applicant</td>
                                    <td>2,500</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-list-search">
                            ...
                            <tbody>
                                <tr>
                                    <td>Initial consultation Fee – Skype/In person</td>
                                    <td>100</td>
                                </tr>
                                <tr>
                                    <td>Tier 2 (General) Visa - Main Applicant</td>
                                    <td>750</td>
                                </tr>
                                <tr>
                                    <td>Tier 4 (Student) Visa - Main Applicant</td>
                                    <td>700</td>
                                </tr>
                                <tr>
                                    <td>Tier 4 (Child) Visa - Main Applicant</td>
                                    <td>800</td>
                                </tr>
                                <tr>
                                    <td>Short-term Study Visa - Main Applicant</td>
                                    <td>550</td>
                                </tr>
                                <tr>
                                    <td>Turkish Worker Visa - Main Applicant</td>
                                    <td>1,250</td>
                                </tr>
                                <tr>
                                    <td>Tier 5 Visa - Main Applicant</td>
                                    <td>750</td>
                                </tr>
                                <tr>
                                    <td>Spouse Visa - Main Applicant</td>
                                    <td>850</td>
                                </tr>
                                <tr>
                                    <td>Unmarried Partner Visa - Main Applicant</td>
                                    <td>950</td>
                                </tr>
                                <tr>
                                    <td>Visitor Visa - Main Applicant</td>
                                    <td>450</td>
                                </tr>
                                <tr>
                                    <td>European Schengen Visa</td>
                                    <td>250</td>
                                </tr>
                                <tr>
                                    <td>ILR (PBS and others) - Main Applicant</td>
                                    <td>750</td>
                                </tr>
                                <tr>
                                    <td>ILR (10-year route) - Main Applicant</td>
                                    <td>1000</td>
                                </tr>
                                <tr>
                                    <td>ILR (Spouse) - Main Applicant</td>
                                    <td>750</td>
                                </tr>
                                <tr>
                                    <td>EEA Qualified Person - Main Applicant</td>
                                    <td>350</td>
                                </tr>
                                <tr>
                                    <td>EEA Family Member - Main Applicant</td>
                                    <td>500</td>
                                </tr>
                                <tr>
                                    <td>EEA Permanent Residence - Main Applicant</td>
                                    <td>550</td>
                                </tr>
                                <tr>
                                    <td>Each Dependant applying at the same time</td>
                                    <td>300</td>
                                </tr>
                                <tr>
                                    <td>Dependant applying separately</td>
                                    <td>550</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>EEA Family Permit Main Applicant</td>
                                    <td>500</td>
                                </tr>
                                <tr>
                                    <td>Registration of Minors as British Citizens (MN1/T)</td>
                                    <td>450/500</td>
                                </tr>
                                <tr>
                                    <td>Out of time applications</td>
                                    <td>1,200</td>
                                </tr>
                            </tbody>
                        </table>
                        <br>
                        <h3 class="item-title">CORPORATE IMMIGRATION</h3>
                        <table class="table table-list-search">
                            <thead>
                                <tr>
                                    <th>Services</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>Tier 2 Sponsorship Licence (Large Company)</td>
                                    <td>4,000</td>
                                </tr>
                                <tr>
                                    <td>Tier 2 Sponsorship Licence (Small Company)</td>
                                    <td>1,500</td>
                                </tr>
                                <tr>
                                    <td>Tier 4 Sponsorship Licence (Large Company)</td>
                                    <td>5,000</td>
                                </tr>
                                <tr>
                                    <td>Tier 4 Sponsorship Licence (Small Company)</td>
                                    <td>5,000</td>
                                </tr>
                            </tbody>
                        </table>
                        <br>
                        <h2>DISCLAIMER</h2>
                        <p style="font-size:12px;">The information provided in this website is for general information purposes only. The information is provided by Mann’s Solutions and while we endeavour to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website for any purpose. Any reliance you place on such information is therefore strictly at your own risk.
                            <br>
                            <br> The information presented in this website does not imply or represent an offer or solicitation. For current fees please contact the staff and ask directly. If a different price is mentioned, we take no responsibility that the site at the current time is not properly updated as the prices might depend on the individual cases and the website will not properly represent it. By viewing these prices, you agree to that term.
                            <br>
                            <br> The fee for the consultation can be deducted from the fee of the service if the individual agrees to instruct us.
                            <br>
                            <br> Every effort is made to keep the website up and running smoothly. However, Mann’s Solutions takes no responsibility for, and will not be liable for, the website being temporarily inaccessible due to technical issues beyond our control.</p>
                    </div>
                </div>
            </div>
        </div>
